...
class MapTourController: UIViewController {
    // Propertys
    ...
    func setUI() {
        ...
        let camera = GMSCameraPosition.camera(withLatitude: lat, longitude: log, zoom: 6.0)
        ...
        buttonRecording.backgroundColor = .systemGreen
...
extension MapTourController: CLLocationManagerDelegate {
