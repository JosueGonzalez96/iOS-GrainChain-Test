...
//  iOS GrainChain Test
//
//  Created by Alberto Josue Gonzalez Juarez on 09/08/21.
...
extension TourDetailController: UITableViewDelegate {
    
}

extension TourDetailController: UITableViewDataSource {
